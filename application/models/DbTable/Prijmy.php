...
class Application_Model_DbTable_Prijmy extends Zend_Db_Table_Abstract
{
    ...
    public function addPrijem($datum_prijmu,
        ...
        $data = array(
            ...
            'q_vlhkost' => $q_vlhkost,
            'cena_jednotkova_nakupna' => $cena_jednotkova_nakupna,
            'cena_jednotkova_predajna' => $cena_jednotkova_predajna,
            'kapacita_kamionu_prm' => $kapacita_kamionu_prm,
...
//            'doklad_typ_enum' => $doklad_typ,
    ...
    public function getPrijmyAjax()
    {
        ...
        $stmt = $db->query(
            ...
            cena_jednotkova_nakupna AS nakupna,
            cena_jednotkova_predajna AS predajna,
